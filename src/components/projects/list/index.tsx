...
export const ProjectsList = () => {
  ...
  const handleDeleteClick = (projectId: Id<"projects">, projectName: string) => {
        ...
        <AlertDialogContent className="backdrop-blur-xl bg-black/90 border border-white/[0.12]">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/70">
              &quot;{projectToDelete?.name}&quot; will be moved to trash. You can restore it
              within 90 days, after which it will be permanently deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
